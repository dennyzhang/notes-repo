...
3. **On failure:** Read the error, diagnose root cause, fix, amend, resubmit. Don't leave failing signals for the reviewer to discover.
4. **On success:** Diff is clean for review. If `--publish-when-ready` was used, it auto-publishes.
