...
- Triage discipline: `../../mrs-ot-agent-src/human-input/triage-discipline.md` (OT-specific R1-R21, ground truth) + `~/notes/users/dennyzhang/cheatsheets/oncall/triage-methodology.md` (generic R1-R13, ground truth). The `human-input-{domain,generic}/` copies are deprecated stubs.
