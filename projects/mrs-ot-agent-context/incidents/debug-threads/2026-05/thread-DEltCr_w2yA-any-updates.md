...
| path | what changed |
|---|---|
| `mrs-ot-agent-context/learnings/failure-patterns.md` | CL-017 escalated to ACCELERATING; CL-008 new sub-class R14+R23; header updated to 2026-05-17 |
| `mrs-ot-agent-context/incidents/debug-threads/2026-05/` | 36 false-positive archives removed; 24 remain (15 verified + 9 true-OT stubs) |
