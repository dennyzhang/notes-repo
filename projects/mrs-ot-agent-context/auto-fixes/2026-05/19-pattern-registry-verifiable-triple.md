...
target:
  - notes/users/dennyzhang/projects/mrs-ot-agent-context/auto-learnings/patterns/failure-patterns.md  # CL-NNN cluster registry
  - notes/users/dennyzhang/projects/mrs-ot-agent-context/auto-learnings/patterns/failure-modes.md     # M-NNN registry
...
- `notes/users/dennyzhang/projects/mrs-ot-agent-context/auto-fixes/2026-05/03-registry-first-triage.md` — predecessor: bot MUST consult registry before verdict (this fix adds: registry entries must be VERIFIED before bot trusts them)
