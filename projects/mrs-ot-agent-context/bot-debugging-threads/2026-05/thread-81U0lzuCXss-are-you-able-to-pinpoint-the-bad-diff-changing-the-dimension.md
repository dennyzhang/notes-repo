...
- (2026-05-29T01:07:22Z) Denny filed L63 + L64 in `mrs-ot-agent-context/auto-learnings/daily-ledger.md`: L63 = push-harder generic, L64 = during `scope_check=DEGRADED` never emit specific tensor shapes or error fragments.

## Files / artifacts touched

| path | what changed |
|---|---|
| `mrs-ot-agent-context/auto-learnings/daily-ledger.md` | L63 (push-harder rule), L64 (DEGRADED narrative suppression) filed |
