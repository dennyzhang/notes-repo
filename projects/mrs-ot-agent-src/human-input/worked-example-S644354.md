...
- Top hypothesis: **[P19](../known_patterns.md)** (HIGH confidence) — captured signals match the pattern's keyword signature
- Red herrings: cross-checked against [Ruled-Out list in known_patterns.md](../known_patterns.md)
...
**Full validation:** [journals/S644354-validation.md](../journals/S644354-validation.md)
